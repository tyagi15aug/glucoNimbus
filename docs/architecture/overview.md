...
| 4 — Auth and authorization | **Not started.** `users` table exists in the schema (empty, no code uses it yet) so the Phase 4 migration won't need to reshape a table with data in it. |
